	...
	$(window).on('load', function() {
		setTimeout(function() {
			$.gritter.add({
				...
				text: 'Aplikasi Monitoring Banjir',
...
// indikator banjir 
let indikator = function(nilai) {
  let status, level, button;
  if(nilai < 40){
    status = 'note-green';
    level = 'Aman';
    button = 'btn-success'
  ...
  let tpl = `<div class="note ${status}">
                <div class="note-icon">
                  <button class="btn ${button} btn-lg m-5 p-5">
                    <i class="fas fa-power-off fa-2x text-white"></i>
                    Pannic Button
                  </button>
                </div>
                <div class="note-content">
                  <h4><b>Level Air ${level}</b></h4>
...
// myApps.makeWidget = function () {
//     myApps.getRandomData([1],4)
//     console.log('sdasdad');
// }
// setTimeout(myApps.makeWidget, 1000);